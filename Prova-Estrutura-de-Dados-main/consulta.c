...
int main(int argc, char *argv[]) {
    ...
    if (timestamp_alvo == -1) {
        printf("Erro: Data e hora fornecidas resultam em um timestamp invalido.\n");
        return 1;
    }
    ...
    if (arquivo_sensor == NULL) {
        printf("Erro: Arquivo do sensor '%s' nao encontrado. Certifique-se de que o Programa 1 foi executado.\n", id_sensor_alvo);
        return 1;
    }
